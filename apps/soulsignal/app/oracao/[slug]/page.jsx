...
export default async function PrayerPage({ params }) {
  ...
  const path = `/oracao/${slugParam}`;
  const intentLabel = INTENT_LABELS[signal.intent] ?? 'Orações';
      ...
      <article>
        <header style={{ marginBottom: 'var(--space-5)' }}>
          <div style={{ marginBottom: 'var(--space-3)' }}>
            <a className="tag" href="/oracao" style={{ textDecoration: 'none' }}>
              Orações
            </a>
