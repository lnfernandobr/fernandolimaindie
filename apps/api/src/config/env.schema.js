...
export const envSchema = z.object({
  ...
  INSTAGRAM_VIDEO_FONT_FILE: z.string().default(ENV_DEFAULTS.INSTAGRAM_VIDEO_FONT_FILE),
  INSTAGRAM_MUSIC_DIR: z.string().default(ENV_DEFAULTS.INSTAGRAM_MUSIC_DIR),
